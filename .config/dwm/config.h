...
static char* fonts[] = {
  ...
  // "sans-serif:pixelsize=20",
  // "sans-serif:lang=ja:size=10",
  "monospace:pointsize=16",
  "Twemoji:pointsize=16"
};
...
const char* spncmpcpp[] = { TERMINAL, "-n", "ncmpcpp", "-g",
                            "80x15",  "-e", "ncmpcpp", NULL };
const char* splfcd[] = { TERMINAL, "-n", "lfcd", "-g",   "80x15", "-e",
                         "zsh",    "-i", "-c",   "lfcd", NULL };
const char* spvim1[] = { TERMINAL, "-n", "spvim1", NULL };
const char* spvim2[] = { TERMINAL, "-n", "spvim2", NULL };
const char* sqbittorrent[] = { "qbittorrent", NULL };
const char* sncpamixer[] = { TERMINAL, "-n",        "ncpamixer",
                             "-e",     "ncpamixer", NULL };
...
#define SPAPP(INSTANCE, TAG, LEFT, TOP, RIGHT, BOTTOM)                         \
  { NULL, INSTANCE, NULL, SPTAG(TAG), 1,      1,       0,                      \
    1,    LEFT,     TOP,  RIGHT,      BOTTOM, borderpx },
...
static const Rule rules[] = {
  ...
  SPAPP("lfcd", 3, TH2, HF, 0, 0) SPAPP("qbittorrent", 4, 0, 0, 0, 0)
    SPAPP("ncpamixer", 5, 0.3, 0.3, 0.3, 0.3)
      SPAPP("telegram", 6, TH1, 0, TH1, 0) SPAPP("spotify", 6, TH1, 0, TH1, 0)
};
