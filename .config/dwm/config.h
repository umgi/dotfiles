...
static char selbordercolor[]        = "#f92672";
...
static Key keys[] = {
	...
	/* j and k to move focus, v - main focus */
	/* J and K to move window, V - set as main window */
	...
	/* gaps */
	{ MODKEY,		XK_z,	incrgaps,	{.i = +3 } },	/* inc */
	{ MODKEY,		XK_x,	incrgaps,	{.i = -3 } },	/* dec */
	{ MODKEY,		XK_a,	togglegaps,	{0} },		/* toggle */
	{ MODKEY|ShiftMask,	XK_a,	defaultgaps,	{0} },		/* reset */

	{ MODKEY,		XK_b,		togglebar,	{0} },	/* toggle bar */
	{ MODKEY,		XK_f,		togglefullscr,	{0} },	/* fullscreen */
	{ MODKEY|ShiftMask,	XK_space,	togglefloating,	{0} },	/* toggle fullscreen */
	...
	{ MODKEY,			XK_BackSpace,	spawn,		SHCMD("sysact.sh") },
	{ MODKEY|ShiftMask,		XK_BackSpace,	spawn,		SHCMD("sysact.sh") },
