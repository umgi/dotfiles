...
{
  setgaps(
    selmon->gappoh + arg->i, selmon->gappov, selmon->gappih, selmon->gappiv);
}
...
{
  setgaps(
    selmon->gappoh, selmon->gappov + arg->i, selmon->gappih, selmon->gappiv);
}
...
{
  setgaps(
    selmon->gappoh, selmon->gappov, selmon->gappih + arg->i, selmon->gappiv);
}
...
{
  setgaps(
    selmon->gappoh, selmon->gappov, selmon->gappih, selmon->gappiv + arg->i);
}
         ...
         int* sr)
{
  ...
  *mr =
    msize - mtotal; // the remainder (rest) of pixels after an even master split
  *sr =
    ssize - stotal; // the remainder (rest) of pixels after an even stack split
}
