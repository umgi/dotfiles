...
-- local kv = ""
-- for k, v in pairs(gdk) do
-- 	kv = kv .. tostring(k) .. ": " .. tostring(v) .. "\n"
-- end
...
-- ============================================================
-- Colors
local colors = require("3rd.awesome-wm-nice.colors")
...
-- Shapes
local shapes = require("3rd.awesome-wm-nice.shapes")
...
-- ============================================================
local table = table
local t = require("3rd.awesome-wm-nice.table")
table.save = t.save
table.load = t.load
...
local function get_dominant_color(client)
	local color
	gsurface(client.content):write_to_png("/home/mutex/nice/" .. client.class .. "_" .. client.instance .. ".png")
	local pb
	local bytes
	local tally = {}
