-- mpv-manga-reader
-- script by Dudemanguy
-- license gpl3.0
-- commit on May 8 : "also unset force-media-title on toggle"
...
function set_keys()
  ...
  -- mouse wheel patch
  mp.add_forced_key_binding("MOUSE_BTN3", "pan-up",   pan_up,   "repeatable")
  mp.add_forced_key_binding("MOUSE_BTN4", "pan-down", pan_down, "repeatable")
